...
const TenantDashboard = () => {
    ...
    useEffect(() => {
        ...
        const fetchDashboardData = async () => {
            try {
                const response = await fetch("http://localhost:4000/api/users/tenant-dashboard", {
                    method: "GET",
                    headers: {
                ...
                toast.error("Error fetching tenant dashboard");
                console.log("Error fetching tenant dashboard:", error);
                navigate("/");
            }
        };
    ...
    const handleProfileUpdate = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                const updatedDataResponse = await fetch("http://localhost:4000/api/users/tenant-dashboard", {
                    method: "GET",
                    headers: {
                        "Content-Type": "application/json",
                        Authorization: `Bearer ${token}`,
    ...
    return (
        <div className="dashboard-container">
            <div className="sidebar">
                ...
                <ul>
                    <li onClick={() => navigate("/tenant-profile")}>Profile</li>
                    ...
                    <li onClick={() => navigate("/my-rental")}>My Rental</li>
